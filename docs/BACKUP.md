...
For more information on how Twistlock's built-in backup process works, see [the official documentation](https://docs.prismacloud.io/en/compute-edition/34/admin-guide/configure/disaster-recovery).
