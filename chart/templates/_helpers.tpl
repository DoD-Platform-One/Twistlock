...
{{- $twistlockDefenderName := include "twistlock-defender.name" . }}
{{- $_ := set $additionalLabels "app.kubernetes.io/name" $twistlockDefenderName }}
{{- $_ := set $additionalLabels "app.kubernetes.io/app" $twistlockDefenderName }}
...
{{- $twistlockInitName := include "twistlock-init.name" . }}
{{- $_ := set $additionalLabels "app.kubernetes.io/name" $twistlockInitName }}
{{- $_ := set $additionalLabels "app.kubernetes.io/app" $twistlockInitName }}
{{- $_ := set $additionalLabels "app" $twistlockInitName }}
{{- $podLabels := mustMergeOverwrite $additionalLabels $podLabels }}
{{- toYaml $podLabels }}
{{- end -}}
...
{{- $podLabels := include "base.selector" . | fromYaml }}
{{- $twistlockConsoleName := include "twistlock-console.name" . }}
{{- $additionalLabels := dict "name" $twistlockConsoleName }}
{{- $_ := set $additionalLabels "app.kubernetes.io/name" $twistlockConsoleName }}
{{- $_ := set $additionalLabels "app.kubernetes.io/app" $twistlockConsoleName }}
{{- $_ := set $additionalLabels "app" $twistlockConsoleName }}
{{- $podLabels := mustMergeOverwrite $additionalLabels $podLabels }}
{{- toYaml $podLabels }}
{{- end -}}
